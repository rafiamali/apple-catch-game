...
boolean menu=true;  //halaman menu awal (game mulai saat kondisi nya false)
...
int apple_no= 4;  //jumlah apel yang tampil di layar
int score= 0;
...
void setup()
{
  ...
  //load the sound file
  music = new SoundFile(this, "rock.mp3");
  ...
  if (menu==true){
    ...
    if(!game_over && music.isPlaying()){
      ...
      lifeScore_display();
        ...
        gameWin(); //menang jika musik telah habis/stop
    }
  }
}
